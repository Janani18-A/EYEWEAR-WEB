    ...
    <div class="container">
        ...
        <div class="wishlist-header d-flex flex-wrap align-items-center justify-content-between gap-2 gap-sm-3 mb-4 mb-md-5 pb-3 border-bottom">
            ...
            <div class="d-flex align-items-center gap-2 gap-sm-3 flex-wrap">
                ...
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-arrow-up-wide-short text-muted" style="font-size: clamp(0.3rem, 0.4vw, 0.7rem);"></i>
                    <select id="sortSelect" class="form-select form-select-sm rounded-pill" style="border-color: rgba(0,0,0,0.08); font-size: clamp(0.65rem, 0.9vw, 0.8rem); padding: clamp(0.15rem, 0.5vw, 0.25rem) clamp(0.5rem, 1vw, 0.75rem);">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function attachEvents() {
        ...
        sortSelect.addEventListener('change', function() {
            ...
            switch (value) {
                ...
                case 'rating': sorted.sort((a, b) => (b.rating || 4.8) - (a.rating || 4.8)); break;
    ...
    function showToast(message) {
        ...
        gsap.to(toast, { x: 0, duration: 0.5, ease: 'power2.out', onComplete: () => {
            setTimeout(() => {
...
.remove-heart:hover { transform: scale(1.1); }
...
.product-meta .sep { margin: 0 0.3rem; opacity: 0.3; }
.product-rating {
...
.add-btn:hover { background: #0A2A1F; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(15,61,46,0.12); }
.add-btn.added { background: #22c55e; }
.add-btn i { font-size: clamp(0.5rem, 0.8vw, 0.7rem); }
...
.remove-btn i { font-size: clamp(0.45rem, 0.7vw, 0.65rem); }
.remove-btn:hover { color: #ec4899; background: rgba(236,72,153,0.04); border-color: rgba(236,72,153,0.08); }
